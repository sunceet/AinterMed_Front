    ...
    <>
      ...
      >
        ...
        <div ref={profileRef} className="relative">
          ...
          <div
            className={`absolute left-0 bottom-[80px] w-full bg-white/20  dark:bg-[#23252740]  backdrop-blur-md shadow-xl rounded-xl py-2 z-50 flex flex-col gap-1 border border-[#e0e0e0] dark:border-[#333] transition-all duration-300
