        ...
        {plans.map((plan, idx) => (
          ...
          >
            ...
            <button
              ...
              className={
                idx === 0
                  ? "w-full h-[56px] rounded-full text-black font-[Involve] text-[15px] font-medium uppercase tracking-wide transition-transform duration-100 touch-manipulation bg-[#F5F6F6] hover:scale-105 cursor-pointer mb-2"
                  : `w-full h-[56px] cursor-pointer touch-manipulation rounded-full text-white font-[Involve] text-[15px] font-medium uppercase tracking-wide transition ${plan.buttonColor}`
              }
            >
              {idx === 0 ? t("pricing.button_free") : t("pricing.button")}
            </button>
          </div>
        ))}
      </div>
