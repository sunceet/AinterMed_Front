    ...
    <div className="mt-15 flex flex-col items-center gap-6 px-4 sm:px-6">
      ...
      >
        ...
        <div className="flex flex-col xl:flex-row-reverse items-center justify-between gap-8">
          <div className="text-center text-left xl:text-right max-w-[720px]">
            ...
            <p className="text-white font-[Manrope] font-normal text-left xl:text-right tracking-wide text-[18px] sm:text-[14px] md:text-[15px] lg:text-[16px] xl:text-[17px] leading-[24px] sm:leading-[20px] md:leading-[22px] lg:leading-[24px] xl:leading-[26px] mt-2">                 Разработано медиками для медиков: Наш продукт создан медицинскими
