...
const VideoDesktop = ({ onLoaded, isMobile }) => {
  ...
  return (
    <>
      <video
        ref={desktopRef}
        className="hidden lg:block pointer-events-none absolute top-[300px] md:top-[420px] lg:top-[520px] xl:top-[540px] left-1/2
      ...
      <video
        ref={mobileRef}
        className="block lg:hidden pointer-events-none absolute top-[430px] sm:top-[480px]  md:top-[490px] left-1/2
