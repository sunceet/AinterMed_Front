...
import VectorPhone1 from "../../assets/svg/VectorPhone1.svg";
import VectorPhone2 from "../../assets/svg/VectorPhone2.svg";
import AboutUsBlock1 from "../../assets/svg/AboutUsBlock1.png";
import AboutUsBlock2 from "../../assets/svg/AboutUsBlock2.png";
    ...
    <div className="mt-15 flex flex-col items-center gap-6 px-4 sm:px-6">
      ...
      >
        ...
        <img
          src={Vector1}
          alt=""
          className="hidden sm:block absolute top-1/2 left-[170px] -translate-y-1/2 h-[101%] w-auto object-cover object-center max-w-none pointer-events-none -z-[1]"
        />
        <img
          src={VectorPhone1}
          alt=""
          className="block sm:hidden absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[101%] w-auto object-cover object-center max-w-none pointer-events-none -z-[1]"
        />
        ...
        <div className="flex flex-col xl:flex-row items-center justify-between gap-8">
          <div className="text-left max-w-[550px]">
            ...
            <div className="mt-6 xl:hidden flex justify-center sm:justify-start">
              <a
                href="/about"
                className="inline-block px-15 py-3 backdrop-blur-sm bg-[#00000033] text-white font-[Involve] font-normal tracking-wide rounded-full uppercase transition"
              >
                {t("aboutUs.button")}
              </a>
            </div>
      ...
      >
        ...
        <img
          src={VectorPhone2}
          alt=""
          className="block sm:hidden absolute top-1/2 left-[36%] -translate-x-1/2 -translate-y-1/2 h-[101%] w-auto object-cover object-center max-w-none pointer-events-none -z-[1]"
        />
