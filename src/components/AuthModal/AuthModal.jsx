...
// Импорт SVG/PNG из src/assets/svg
import EyeOpenIcon from "../../assets/svg/eye-open.svg";
import EyeCloseIcon from "../../assets/svg/eye-close.svg";
import CheckboxIcon from "../../assets/svg/checkbox.svg";
import LoginImage from "../../assets/svg/login.png";
import RegisterImage from "../../assets/svg/register.png";
...
export default function AuthModal({ onClose, mode = "register" }) {
  ...
  const imageSrc = isLogin ? LoginImage : RegisterImage;
  ...
  const isFormValid = () => {
    if (isLogin) {
      ...
      return name.trim() && isValidEmail(email) && password.trim() && agreed;
    }
  };
          ...
          <div className={`${isLogin ? "pt-5 md:pt-40" : "pt-10 md:pt-20"}`}>
            ...
            <p className="text-center mt-4 text-[13px] xl:text-[16px] md:text-[18px] text-[#5B5B5B] font-[Manrope]">
              ...
              <button
                ...
                className="text-[#438EFF] cursor-pointer underline"
              >
